...
internal class LoadBalancingPeer : PhotonPeer
{
    ...
    public virtual bool OpGetRegions(string appId)
    {
        ...
        return this.SendOperation(OperationCode.GetRegions, parameters, new SendOptions { Reliability = true, Channel = 0, Encrypt = true });
    }
    ...
    public virtual bool OpAuthenticate(string appId, string appVersion, AuthenticationValues authValues, string regionCode, bool getLobbyStatistics)
    {
        ...
        bool sent = this.SendOperation(OperationCode.Authenticate, opParameters,
            new SendOptions {Reliability = true, Channel = 0, Encrypt = this.IsEncryptionAvailable});
        if (!sent)
        {
    ...
    public virtual bool OpAuthenticateOnce(string appId, string appVersion, AuthenticationValues authValues, string regionCode, EncryptionMode encryptionMode, ConnectionProtocol expectedProtocol)
    {
        ...
        return this.SendOperation(OperationCode.AuthenticateOnce, opParameters,
            new SendOptions {Reliability = true, Channel = 0, Encrypt = this.IsEncryptionAvailable});
    }
    ...
    public virtual bool OpRaiseEvent(byte eventCode, object customEventContent, bool sendReliable, RaiseEventOptions raiseEventOptions)
    {
        ...
        return this.SendOperation(OperationCode.RaiseEvent, opParameters,
            new SendOptions
            {
