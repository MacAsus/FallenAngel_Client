...
namespace ExitGames.Demos.DemoPunVoice {
    ...
    public class VoiceDemoUI : MonoBehaviour {
        ...
        private void InitToggles(Toggle[] toggles) {
            ...
            for (int i = 0; i < toggles.Length; i++) {
                ...
                switch (toggle.name) {
                    ...
                    case "DebugEcho":
                        toggle.isOn = (rec != null && rec.DebugEchoMode);
                        break;
        ...
        private void VoiceSwitchOnClick() {
            ...
            else if (PhotonVoiceNetwork.ClientState == Client.Photon.LoadBalancing.ClientState.PeerCreated
        ...
        private void Update() {
            ...
            switch (PhotonVoiceNetwork.ClientState) {
                case Client.Photon.LoadBalancing.ClientState.Joined:
                    ...
                    break;
                case Client.Photon.LoadBalancing.ClientState.PeerCreated:
